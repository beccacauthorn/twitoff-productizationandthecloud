#C:\Users\becca\Desktop\Web Application Development with Flask\twitoff-productizationandthecloud\web_app\routes\twitter_routes.py
...
def get_user(screen_name=None):
    ...
    #breakpoint()
    return "OK"
    #return render_template("user.html", user=db_user, tweets=statuses) # tweets=db_tweets2